...
from app.dependencies import cashier_user, db_dep
...
def get_unpaid_orders(user: cashier_user, db: db_dep):
...
@router.get("/orders/paid", response_model=list[CashierUnpaidOrderResponse])
def get_paid_orders(user: cashier_user, db: db_dep):
...
def get_order_summary(order_id: int, user: cashier_user, db: db_dep):
...
def create_payment(order_id: int, data: CreatePaymentRequest, user: cashier_user, db: db_dep):
...
def close_order(order_id: int, user: cashier_user, db: db_dep):
